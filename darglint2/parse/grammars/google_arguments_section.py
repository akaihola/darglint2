...
class ArgumentsGrammar(BaseGrammar):
    productions = [
        ...
        P(
            ...
            ([ArgumentIdentifier, EmptyTypeError], "indent", "head-argument3", 2),
            (
        ...
        P(
            "type-section-parens0",
            ([], "type-words-colon", "rparen", 0),
            (TokenType.RPAREN, 0),
        ),
        P(
            "type-words-colon0",
            ([], "newline", "type-words-colon1", 0),
            (TokenType.NEWLINE, 0),
        ),
        P(
            "type-words-colon1",
            ([], "indents", "type-words-colon", 0),
            ([], "indent", "indents", 0),
            (TokenType.INDENT, 0),
            ([], "type-word-colon", "type-words-colon", 0),
            ([], "type-word-colon", "type-words-colon0", 0),
