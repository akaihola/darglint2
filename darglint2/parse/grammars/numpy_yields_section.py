...
from darglint2.parse.identifiers import NoqaIdentifier, YieldTypeIdentifier
...
class YieldsGrammar(BaseGrammar):
    productions = [
        P(
            "yields-section",
            ([], "yields-header", "newlines", 0),
            ([], "yields-header", "yields-section1", 0),
            ([], "yields", "yields-header0", 0),
        ),
        ...
        P(
            ...
            ([], "indented", "line", 0),
            ([], "yields-argument", "yields-body-typed0", 0),
            ([], "yields-argument", "yields-body-typed2", 0),
        ),
        P(
            "yields-body-typed",
            ([], "yields-argument", "yields-body-typed0", 0),
        ...
        P(
            "yields-argument",
            ([YieldTypeIdentifier], "ident", "yields-argument1", 0),
            ([YieldTypeIdentifier], "ident", "newline", 0),
        ),
        P(
            "block-indented",
            ([], "paragraph-indented", "block-indented0", 0),
