...
class ArgumentTypeGrammar(BaseGrammar):
    productions = [
        P(
            ...
            ([], "ahead", "argument-type-section1", 0),
            ([], "ahead-no-follow", "newlines", 0),
            ([EmptyDescriptionError], "colon", "ahead-no-follow1", 0),
        ),
        ...
        P(
            ...
            (TokenType.ARGUMENT_TYPE, 2),
            (TokenType.RETURNS, 2),
            (TokenType.RETURN_TYPE, 2),
            (TokenType.YIELDS, 2),
            (TokenType.YIELD_TYPE, 2),
            (TokenType.VARIABLES, 2),
            (TokenType.VARIABLE_TYPE, 2),
            (TokenType.NOQA, 2),
            (TokenType.OTHER, 2),
            (TokenType.RECEIVES, 2),
            (TokenType.WARNS, 2),
            (TokenType.SEE, 2),
            (TokenType.ALSO, 2),
            (TokenType.NOTES, 2),
            (TokenType.EXAMPLES, 2),
            (TokenType.REFERENCES, 2),
            (TokenType.HEADER, 2),
            ([IndentError], "line", "item-body7", 1),
        ),
        P(
            "block-indented",
        ...
        P(
            "argument-type-section1",
            ([], "item-body", "newlines", 0),
            ([], "line", "item-body0", 2),
            ([], "line", "item-body1", 2),
            ([], "line", "item-body2", 2),
            ([], "word", "line", 2),
