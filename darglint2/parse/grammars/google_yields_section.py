# Generated on 2023-02-05 17:17:13.888916
...
class YieldsGrammar(BaseGrammar):
    productions = [
        ...
        P("yields-body", ([], "indented", "yields-body0", 0), ([], "indented", "yields-content-colonless", 0)),
        P("yields-type", ([], "type-words", "colon", 0), (TokenType.COLON, 0)),
        ...
        P("yields-body0", ([], "yields-type", "yields-content", 0)),
        ...
        P("yields-content-colonless0", ([], "newline", "yields-content-colonless1", 0)),
        P("yields-content-colonless1", ([], "block-indented", "newlines", 0), ([], "paragraph-indented", "block-indented0", 0), ([], "indented", "paragraph-indented0", 0), ([], "indented", "line", 0)),
