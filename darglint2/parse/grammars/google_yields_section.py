...
from darglint2.errors import ParameterMalformedError
...
class YieldsGrammar(BaseGrammar):
    productions = [
        ...
        P(
            "yields-body",
            ([], "indented", "yields-body0", 0),
            ([], "indented", "yields-content-colonless", 0),
        ),
        P("yields-type", ([], "type-words", "colon", 0)),
        P(
            "yields-content",
            ([], "line", "newlines", 0),
            ([], "line", "yields-content0", 0),
            ([], "word", "line", 0),
            ([], "word", "noqa-maybe", 0),
        ...
        P(
            "yields-content-colonless",
            ([], "line-colonless", "newlines", 0),
            ([], "line-colonless", "yields-content-colonless0", 0),
            ([], "word-colonless", "line-colonless", 0),
            ([], "word-colonless", "noqa-maybe", 0),
            ([NoqaIdentifier], "hash", "noqa", 0),
            ([NoqaIdentifier], "noqa-head", "noqa-statement1", 0),
            (TokenType.INDENT, 0),
            (TokenType.WORD, 0),
        ...
        P(
            "type-words",
            ([], "type-word", "type-words", 0),
            ([], "type-word", "type-words0", 0),
            (TokenType.WORD, 0),
            (TokenType.RAISES, 0),
            (TokenType.ARGUMENTS, 0),
            (TokenType.ARGUMENT_TYPE, 0),
