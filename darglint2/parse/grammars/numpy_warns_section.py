...
class WarnsGrammar(BaseGrammar):
    productions = [
        P(
            "warns-section",
            ([], "warns-header", "newlines", 0),
            ([], "warns-header", "warns-section1", 0),
            ([], "warns", "warns-header0", 0),
        ),
        P("warns-header", ([], "warns", "warns-header0", 0)),
        P(
            "warns-body",
            ([], "warns-item", "warns-body", 0),
            ([ExceptionItemIdentifier], "ident", "warns-item1", 0),
        ),
