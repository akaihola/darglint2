...
from darglint2.parse.identifiers import NoqaIdentifier, ReturnTypeIdentifier
...
class ReturnsGrammar(BaseGrammar):
    productions = [
        P(
            "returns-section",
            ([], "returns-header", "newlines", 0),
            ([], "returns-header", "returns-section1", 0),
            ([], "returns", "returns-header0", 0),
        ),
        ...
        P(
            ...
            (TokenType.HEADER, 0),
            ([], "line", "paragraph1", 0),
            ([], "returns-argument", "returns-body-typed0", 0),
            ([], "returns-argument", "returns-body-typed2", 0),
        ),
        P(
            "returns-body-typed",
            ([], "returns-argument", "returns-body-typed0", 0),
        ...
        P(
            "returns-argument",
            ([ReturnTypeIdentifier], "ident", "returns-argument1", 0),
            ([ReturnTypeIdentifier], "ident", "newline", 0),
        ),
        P(
            "block-indented",
