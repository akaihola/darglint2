...
class ReturnsGrammar(BaseGrammar):
    productions = [
        ...
        P(
            "returns-body",
            ([], "indented", "returns-body0", 0),
            ([], "indented", "returns-content-colonless", 0),
        ),
        P("returns-type", ([], "type-words", "colon", 0)),
        P(
            "returns-content",
            ([], "line", "newlines", 0),
            ([], "line", "returns-content0", 0),
            ([], "word", "line", 0),
            ([], "word", "noqa-maybe", 0),
        ...
        P(
            ...
            ([], "line-colonless", "returns-content-colonless0", 0),
        ...
        P(
            "returns-content-colonless0",
            ([], "newline", "returns-content-colonless1", 0),
        ),
        P(
            "returns-content-colonless1",
            ([], "block-indented", "newlines", 0),
            ([], "paragraph-indented", "block-indented0", 0),
            ([], "indented", "paragraph-indented0", 0),
            ([], "indented", "line", 0),
