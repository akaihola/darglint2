# Generated on 2023-02-05 17:17:16.886762
...
class VariableTypeGrammar(BaseGrammar):
    productions = [
        P("variable-type-section", ([], "varhead", "variable-type-section1", 0), ([], "varhead-no-follow", "newlines", 0), ([EmptyDescriptionError], "colon", "varhead-no-follow1", 0)),
        P("varhead", ([], "colon", "varhead0", 0)),
        P("varhead-no-follow", ([EmptyDescriptionError], "colon", "varhead-no-follow1", 0)),
