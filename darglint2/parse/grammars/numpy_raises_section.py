...
class RaisesGrammar(BaseGrammar):
    productions = [
        P(
            "raises-section",
            ([], "raises-header", "newlines", 0),
            ([], "raises-header", "raises-section1", 0),
            ([], "raises", "raises-header0", 0),
        ),
        P("raises-header", ([], "raises", "raises-header0", 0)),
        P(
            "raises-body",
            ([], "raises-item", "raises-body0", 0),
            ([ExceptionItemIdentifier], "ident", "raises-item1", 0),
            (TokenType.WORD, 0),
            (TokenType.RAISES, 0),
            ...
            ([ExceptionItemIdentifier, EmptyTypeError], "ident", "raises-item4", 0),
            ([ExceptionItemIdentifier, EmptyTypeError], "ident", "raises-item8", 0),
        ),
        P(
            "raises-item",
            ([ExceptionItemIdentifier], "ident", "raises-item1", 0),
        ...
        P(
            "raises-item1",
            ([], "noqa-maybe", "raises-item2", 0),
            ([], "newline", "block-indented", 0),
        ),
