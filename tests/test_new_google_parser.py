...
from darglint2.parse.google import lookup, parse, top_parse
from darglint2.parse.identifiers import ArgumentIdentifier, ExceptionIdentifier
from darglint2.token import Token, TokenType
from darglint2.utils import CykNodeUtils

from .utils import random_tokens
...
class NewGoogleParserTests(TestCase):
    def test_top_parse_sections_le_nonnewline_tokens(self):
        ...
        for _ in range(MAX_REPS):
            ...
            self.assertTrue(len(parsed) <= len(tokens))
