# Generated on 2023-02-05 17:17:14.534822
...
class ArgumentTypeGrammar(BaseGrammar):
    productions = [
        P("argument-type-section", ([], "ahead", "argument-type-section1", 0), ([], "ahead-no-follow", "newlines", 0), ([EmptyDescriptionError], "colon", "ahead-no-follow1", 0)),
        P("ahead", ([], "colon", "ahead0", 0)),
        P("ahead-no-follow", ([EmptyDescriptionError], "colon", "ahead-no-follow1", 0)),
